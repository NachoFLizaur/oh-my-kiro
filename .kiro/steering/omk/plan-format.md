...
## Overview
Plan files are the sole handoff artifact between Prometheus and Sisyphus. They live at `.kiro/plans/{kebab-case-name}.md` and follow a strict template.
...
---
*Plan generated by Prometheus | {date}*
...
### Execution Strategy
The "how." Order of operations, key technical decisions, approach rationale. Include file lists (create/modify) so Sisyphus knows what to expect.
...
- **DRAFT**: Being created by Prometheus during interview
- **READY**: Finalized by Prometheus, approved by user, ready for Sisyphus
- **IN_PROGRESS**: Sisyphus is actively executing
